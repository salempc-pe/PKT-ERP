...
export default function CalendarAdminCard({ analytics }) {
  ...
  return (
    <div className="bg-[var(--color-surface-container)] border border-white/5 rounded-2xl p-6 hover:translate-y-[-4px] transition-all duration-300 group">
      ...
      <p className="text-[var(--color-on-surface-variant)] text-xs font-bold uppercase tracking-wider mb-1">Citas Agendadas</p>
      <h4 className="text-2xl font-black text-[var(--color-on-surface)]">{appointments}</h4>
