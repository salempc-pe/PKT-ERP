...
export default function RealEstateModule() {
  ...
  const pipelineStages = [
    ...
    { id: 'negociacion', title: 'Negociación', color: 'bg-[#6B4FD8]' },
                  ...
                  <tr key={t.id} className="hover:bg-[var(--color-surface-container)]/40 transition-colors group cursor-pointer" onClick={() => handleOpenEdit(t)}>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-bold text-[var(--color-on-surface)] group-hover:text-[var(--color-primary)] transition-colors">{t.address}</p>
